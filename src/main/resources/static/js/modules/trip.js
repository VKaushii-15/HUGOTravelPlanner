...
export default class Trip {
  ...
  displayTrip = () => {
    ...
    const filteredDays = this.days.filter((day) => day.trip_id === this.id);
    console.log('Filtered Days:', filteredDays); // Log filtered days
    filteredDays.forEach((day) => {
      const plannerBox = day.renderElement();
      console.log('Rendering Planner Box for Day:', day); // Log each day being rendered
